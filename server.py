...
ALLOWED_ORIGINS = {
    "https://bustracingproject.netlify.app/",   # production
    "http://localhost",                        # local dev (file opened via localhost)
...
def add_cors(response):
    ...
    if (origin in ALLOWED_ORIGINS
        ...
        response.headers["Access-Control-Allow-Origin"]  = "https://bustracingproject.netlify.app/"
